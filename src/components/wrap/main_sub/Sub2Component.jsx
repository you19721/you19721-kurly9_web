...
export default function Sub2Component() {
    ...
    const onClickEvent=(e, item)=>{
        e.preventDefault();
        const obj = {
            image: `${process.env.PUBLIC_URL}/images/sub/sub02/${item.이미지}`,
    ...
    return (
        <main id='mainSub2' className='main-sub'>
            <section id="section1">
                <div className="container">
                    <div className="gap">
                        ...
                        <div className="content">
                            <a href="!#">
                                <img src="./images/sub/sub02/aIcWA1qAhYmdq7llqnbhuurr83QSGPUwaNG2haqc.jpg" alt="" />
                            </a>
                        </div>
                    </div>
                </div>
                                                        ...
                                                        <div className="gap">
                                                            <a href="!#"  onClick={(e)=>onClickEvent(e, item)}>
                                                                <div className="img-box">
                                                                    <img src={`./images/sub/sub02/${item.이미지}`} alt="" />
