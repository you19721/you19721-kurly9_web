...
export default function Sub3Component() {
    ...
    const onClickEvent=(e, item)=>{
        e.preventDefault();
        const obj = {
            image: `${process.env.PUBLIC_URL}/images/sub/sub03/${item.이미지}`,
    ...
    return (
        <main id='mainSub3' className='main-sub'>
            <section id="section1">
                                                        ...
                                                        <div className="gap">
                                                            <a href="!#"  onClick={(e)=>onClickEvent(e, item)}>
                                                                <div className="img-box">
                                                                    <img src={`./images/sub/sub03/${item.이미지}`} alt="" />
